...
const ThemeCard = ({number,seatCount}) => {
            ...
            <div>
                {currentPage.pathname === '/date_reservation' ? (
                    ...
                    <p className='inputpage_theme'>
                        ...
                        예약이 완료되면 확인 팝업이 표시되며, 해당 내용은 예약 취소 페이지를 통해 언제든지 확인하실 수 있습니다.
                        부득이하게 예약을 변경하거나 취소하실 경우, <strong>방문 하루 전까지</strong> 온라인으로 처리하실 수 있습니다. <br /><br />
                        저희 레스토랑은 <strong>1인당 3만원</strong>입니다.<br />
                        현재 선택하신 좌석은 <span>{typeof number === 'object' ? number?.number : number} 테이블</span>입니다.
                        해당 테이블은 기본 <strong>{seatCount}인석으로 최대 {seatCount+2}인</strong>까지 수용이 가능합니다. <br /><br />
